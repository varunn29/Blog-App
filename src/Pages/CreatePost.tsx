...
function CreatePost()
{
    return (
        <div className="text-white p-10 max-w-6xl m-auto">
            ...
            <form className="flex flex-col border border-zinc-800 rounded-3xl shadow-xl bg-zinc-900 p-10">
                <div className="mb-8">
                    <label className="flex gap-2 items-center text-xl font-bold" htmlFor="title"><FileText/>Title</label>
                    <input className="w-full mt-3 rounded-xl bg-zinc-800 border border-zinc-700 px-4 py-3 outline-none focus:border-blue-500" id="title" type="text" placeholder="Enter article title..."/>
                </div>

                <div className="mb-8">
                    <label className="flex gap-2 items-center text-xl font-bold" htmlFor="description"><TextAlignStart/>Description</label>
                    <input className="w-full mt-3 rounded-xl bg-zinc-800 border border-zinc-700 px-4 py-3 outline-none focus:border-blue-500" id="description" type="text" placeholder="Short description..."/>
                </div>
                ...
                <div className="mb-8">
                    ...
                    <textarea className="w-full mt-3 rounded-xl bg-zinc-800 border border-zinc-700 p-4 outline-none resize-none focus:border-blue-500" id="content" placeholder="Write your article here..." rows={18}></textarea>
                </div>

                <div className="flex justify-end gap-4 mt-5">
                    <button className="px-6 py-3 rounded-xl border border-zinc-700 hover:bg-zinc-800">Cancel</button>
                    <button className="px-8 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 font-semibold">Publish</button>
                </div>
            </form>
        </div>
    )
